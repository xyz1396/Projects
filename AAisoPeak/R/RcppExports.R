...
getUnfilteredPSMs <- function(workingPath) {
    .Call(`_AAisoPeak_getUnfilteredPSMs`, workingPath)
}
...
precursor_peak_calculator <- function(AAstr) {
    .Call(`_AAisoPeak_precursor_peak_calculator`, AAstr)
}
...
precursor_peak_calculator_DIY <- function(AAstr, Atom, Prob) {
    .Call(`_AAisoPeak_precursor_peak_calculator_DIY`, AAstr, Atom, Prob)
}
...
BYion_peak_calculator_DIY <- function(AAstr, Atom, Prob) {
    .Call(`_AAisoPeak_BYion_peak_calculator_DIY`, AAstr, Atom, Prob)
}
