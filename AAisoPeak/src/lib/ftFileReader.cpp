...
Scan::Scan(int mScanNumber, float mRetentionTime) : scanNumber(mScanNumber),
													retentionTime(mRetentionTime),
													precursorScanNumber(0),
													precursorMz(0),
													precursorCharge(0) {}

Scan::Scan(int mScanNumber, float mRetentionTime, int mPrecusorScanNumber,
...
Scan ftFileReader::readScanNumberRentionTime()
{
	...
	return Scan(mScanNumber, mRetentionTime);
}
...
Scan ftFileReader::readScanNumberRentionTimePrecursor()
{
	...
	return Scan(mScanNumber, mRetentionTime, mPrecusorScanNumber,
