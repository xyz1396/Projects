...
p <-
  plotProSipPct(
    "/mnt/d/ubuntuShare/EcoliSIP/C13pct25orbit/Pan_050922_09_Orbi_Orbi.C13.pro.cluster.txt"
  )
p
...
```{r}
psm <- read.table("/mnt/d/ubuntuShare/EcoliSIP/C13pct25orbit/Pan_050922_09_Orbi_Orbi.C13.psm.txt", header = T)
psm <- arrange(psm, abs(MassErrorDa) ,desc(Score))
ft2 <- readAllScanMS2("/mnt/d/ubuntuShare/EcoliSIP/C13pct25orbit/Pan_050922_09_Orbi_Orbi.FT2")
```
...
# Median Pct: 49%
plotProSipPct(
  "data/AMD_StandardEnrichment_SampleBeta_50Percent13C_Velos_OrbiMS2_Run2_020110.pro.cluster.txt"
)
ggsave("AMDC13pct50SIPresult.pdf",
       width = 8,
       height = 6)

psm <-
  read.table(
    "data/AMD_StandardEnrichment_SampleBeta_50Percent13C_Velos_OrbiMS2_Run2_020110.psm.txt",
    header = T
  )
psm <- arrange(psm, Filename , abs(MassErrorDa), desc(Score))
psm <- psm[1:10, ]
...
ft2 <- readAllScanMS2("/mnt/d/work/202205/AMD_StandardEnrichment_SampleBeta_50Percent13C_Velos_OrbiMS2_Run2_020110_02.FT2")
realScans <- getRealScans(ft2, scanNumbers)
