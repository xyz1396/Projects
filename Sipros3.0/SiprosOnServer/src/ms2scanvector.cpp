...
void MS2ScanVector::searchDatabase()
{
	...
	while(myProteinDatabase.getNextPeptide(currentPeptide))
	{
	    ...
	    assignPeptides2Scans(currentPeptide);
...
void MS2ScanVector::writeOutput()
{
	...
	{
	    if (vpAllMS2Scans.at(i)->vpWeightSumTopPeptides.at(0)->sScoringFunction
		    == "WeightSum")
		calculateMeanAndDeviation(vpAllMS2Scans.at(i)->inumberofWeightSumScore, 
		    vpAllMS2Scans.at(i)->dsumofWeightScore, 
		    vpAllMS2Scans.at(i)->dsumofSquareWeightSumScore,
