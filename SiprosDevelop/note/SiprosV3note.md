...
# optimize by struct smid

```bash
ssh c657
cd /ourdisk/hpc/prebiotics/yixiong/auto_archive_notyet/Projects/learnSipros/test/AMD/siprosV3/Sipros-src-Vector-struct
./make
# running time： 96s
./make run
...
cd timeCompare
# running time： 285s
pprof ../bin/SiprosV3omp test_capture.prof --pdf > Structprof.pdf
```
