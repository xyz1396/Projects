...
void MainWindow::on_actionSave_triggered()
{
    ...
    qInfo() << config::getConfig().Remove_First_Methionine;
    qInfo() << config::getConfig().Training_Decoy_Prefix;
    qInfo() << config::getConfig().Testing_Decoy_Prefix;
    qInfo() << config::getConfig().FDR_Filtering_level;
    qInfo() << config::getConfig().FDR_Threshold;
    qInfo() << config::getConfig().Min_Peptide_Per_Protein;
    qInfo() << config::getConfig().Min_Unique_Peptide_Per_Protein;
    qInfo() << config::getConfig().Filter_Mass_Tolerance_Parent_Ion;
    qInfo() << config::getConfig().Filter_Mass_Tolerance_Parent_Ion_Unit;
    qInfo() << config::getConfig().writeJson();
}
