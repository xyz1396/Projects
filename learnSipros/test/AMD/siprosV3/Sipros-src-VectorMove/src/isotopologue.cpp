...
IsotopeDistribution::IsotopeDistribution(const IsotopeDistribution &mIsotopeDistribution) = default;
// IsotopeDistribution::IsotopeDistribution(const IsotopeDistribution &mIsotopeDistribution)
// 	: vMass{mIsotopeDistribution.vMass}, vProb{mIsotopeDistribution.vProb}
// {
// }

IsotopeDistribution::IsotopeDistribution(IsotopeDistribution &&mIsotopeDistribution)
	: vMass{move(mIsotopeDistribution.vMass)}, vProb{move(mIsotopeDistribution.vProb)}
{
}
...
IsotopeDistribution &IsotopeDistribution::operator=(const IsotopeDistribution &mIsotopeDistribution) = default;
...
// 		return *this;
// 	vMass = mIsotopeDistribution.vMass;
// 	vProb = mIsotopeDistribution.vProb;
// 	return *this;
// }
...
IsotopeDistribution &IsotopeDistribution::operator=(IsotopeDistribution &&mIsotopeDistribution)
{
	if (this == &mIsotopeDistribution)
		return *this;
	vMass=move(mIsotopeDistribution.vMass);
	vProb=move(mIsotopeDistribution.vProb);
	return *this;
}
...
// destructor
IsotopeDistribution::~IsotopeDistribution() = default;
